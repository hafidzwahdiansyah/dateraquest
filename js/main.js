...
if (mbtog && mbmenu) {
    ...
    mbtog.addEventListener("click", function () {

        mbOpen = !mbOpen;

        mbmenu.classList.toggle("open", mbOpen);
...
document.querySelectorAll("#mbmenu a").forEach(link => {
...
if (ptog) {
    ...
    ptog.addEventListener('change', function () {
        ...
        document.getElementById('ptogThumb').style.transform =
            y ? 'translateX(24px)' : 'translateX(0)';
